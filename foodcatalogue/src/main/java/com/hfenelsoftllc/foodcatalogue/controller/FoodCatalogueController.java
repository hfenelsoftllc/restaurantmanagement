...
public class FoodCatalogueController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<FoodItemCatalogueDTO> getFoodItemById(@PathVariable String id) {
    ...
    public ResponseEntity<List<FoodItemCatalogueDTO>> getFoodItemsByRestaurantId(@PathVariable Long restaurantId) {
    ...
    @PostMapping
    public ResponseEntity<FoodItemCatalogueDTO> createFoodItem(@Valid @RequestBody FoodItemCatalogueDTO foodItemCatalogueDTO) {
