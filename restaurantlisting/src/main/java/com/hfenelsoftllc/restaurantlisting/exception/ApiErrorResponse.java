...
public record ApiErrorResponse(
        ...
        String error,
        @Schema(description = "Human-readable error message", example = "Restaurant not found for id: 1")
        String message,
        @Schema(description = "Request path that caused the error", example = "/restaurants/1")
        String path,
